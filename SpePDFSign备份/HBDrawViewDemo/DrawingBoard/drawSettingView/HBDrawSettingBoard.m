...
- (void)setM_pdfModel:(UIImage_PDFModel *)m_pdfModel
{
    _m_pdfModel = m_pdfModel;
    [self.backImageView setPDFImages:self.m_pdfModel.m_arrPDFImages];
}
...
{
    if (!_colors) {
        _colors = [NSArray arrayWithObjects:@"#111111",
                                            @"#aaaaaa",
                                            @"#ed4040",
                                            @"#f5973c",
                                            @"#efe82e",
